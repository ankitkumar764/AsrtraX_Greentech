  ...
  return (
    <div className="home-page">
      <section className="hero-premium" style={{ 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'rgba(255,255,255,0.1)', padding: '8px 20px', borderRadius: '40px', marginBottom: '30px', border: '1px solid rgba(255,255,255,0.2)' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '1px' }}>Agricultural Intelligence</span>
          </div>
      ...
      <section className="demo-premium" style={{ backgroundColor: '#0f172a', padding: '100px 0', color: 'white' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: '800', color: 'white' }}>See It In Action</h2>
            <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1.2rem', maxWidth: '700px', margin: '0 auto' }}>
              Our rule-based engine translates agricultural logic into profitable decisions.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ flex: '1', padding: '60px', borderRight: '1px solid rgba(255,255,255,0.1)', minWidth: '350px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '40px' }}>
                ...
                <h3 style={{ margin: 0, fontSize: '1.8rem' }}>Farm Scenario</h3>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div style={{ padding: '20px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '20px' }}>
                  ...
                  <div>
                    <div style={{ fontSize: '12px', opacity: 0.5, textTransform: 'uppercase', letterSpacing: '1px' }}>Soil Type</div>
                    <div style={{ fontSize: '1.2rem', fontWeight: '700' }}>Sandy Soil</div>
                  </div>
                </div>
                <div style={{ padding: '20px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '20px' }}>
                  <div style={{ fontSize: '2rem' }}>💧</div>
                  <div>
                    <div style={{ fontSize: '12px', opacity: 0.5, textTransform: 'uppercase', letterSpacing: '1px' }}>Water Availability</div>
                    <div style={{ fontSize: '1.2rem', fontWeight: '700', color: 'hsl(0, 72%, 71%)' }}>Low (Rain-fed)</div>
                  </div>
                </div>
                <div style={{ padding: '20px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '20px' }}>
                  <div style={{ fontSize: '2rem' }}>🍚</div>
                  <div>
                    <div style={{ fontSize: '12px', opacity: 0.5, textTransform: 'uppercase', letterSpacing: '1px' }}>Previous Crop</div>
                    <div style={{ fontSize: '1.2rem', fontWeight: '700' }}>Rice</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style={{ flex: '1.3', padding: '60px', minWidth: '350px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '40px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                  ...
                  <h3 style={{ margin: 0, fontSize: '1.8rem' }}>Logic Result</h3>
                </div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.05)', padding: '30px', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)', marginBottom: '30px' }}>
                <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: '1.8rem', fontWeight: '800', color: 'var(--primary-color)', margin: 0 }}>BAJRA (Pearl Millet)</h4>
                    <p style={{ fontSize: '1.1rem', opacity: 0.8, margin: '5px 0 0 0' }}>The most resilient choice for sandy soil.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="impact-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div style={{ padding: '20px', background: 'rgba(34, 197, 94, 0.1)', borderRadius: '20px', border: '1px solid rgba(34, 197, 94, 0.2)', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '12px', opacity: 0.6 }}>Estimated Savings</div>
                </div>
                <div style={{ padding: '20px', background: 'rgba(59, 130, 246, 0.1)', borderRadius: '20px', border: '1px solid rgba(59, 130, 246, 0.2)', textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '12px', opacity: 0.6 }}>Yield Potential</div>
                </div>
              </div>
              ...
              <div style={{ marginTop: '30px', padding: '20px', background: 'rgba(251, 191, 36, 0.1)', borderRadius: '20px', border: '1px solid rgba(251, 191, 36, 0.2)', display: 'flex', gap: '15px' }}>
                ...
                <p style={{ margin: 0, fontSize: '0.9rem', color: '#fbbf24', lineHeight: '1.5' }}>
                  <strong>AGRICULTURAL LOGIC:</strong> System detected Rice residue in sandy soil. Reducing Urea by 15% to leverage existing organic nitrogen and prevent salt buildup.
                </p>
              </div>
            </div>
          </div>
